...
<template>
  <div class="container">
    <pv-card style="width: 420px; margin: 0 auto;">
      <template #title> Login Now </template>
      <template #content>
        ...
        <pv-button @click="attemptLogin" style="margin-top: 10px; margin-left: 130px;">Iniciar sesión</pv-button>
        <p style="margin-top: 23px;margin-left: 75px;">¿No tienes una cuenta? <router-link to="/register">Regístrate</router-link>.</p>
      </template>
    </pv-card>
  </div>
</template>
